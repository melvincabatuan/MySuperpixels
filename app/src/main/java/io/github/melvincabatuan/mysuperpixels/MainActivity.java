package io.github.melvincabatuan.mysuperpixels;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                compactness = progress;
                label1.setText("  Compactness = " + compactness);
        ...
        seekBar2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                texture = progress;
                label2.setText("  Texture = " + texture);
                label2.setTextColor(Color.RED);
            }
    ...
    public native void process(Bitmap pTarget, byte[] pSource, int compactness, int texture);

    private Runnable DoImageProcessing = new Runnable() {
        public void run() {
            bProcessing = true;
            process(imageA, videoSource, compactness, texture);
            imViewA.invalidate();
